...
public class LB_CheckforUpdates : EditorWindow
{
	...
	{		
			if (GUILayout.Button ("Check for updates")) 
			{
					...
					client.DownloadFileAsync (new System.Uri ("http://89.163.206.23/LightingBox_Update_N1.txt"), Application.dataPath + "/"
				+ "LightingBox2/Resources/Config/LightingBox_Update_N1.txt");
