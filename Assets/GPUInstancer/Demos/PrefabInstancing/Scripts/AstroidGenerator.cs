...
namespace GPUInstancer
{
    public class AstroidGenerator : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            //int firstPassColumnSize = count % Mathf.FloorToInt((float) count / columnSize) > 0 ? columnSize - 1 : columnSize;
        ...
        private GPUInstancerPrefab InstantiateInCircle(Vector3 center, int column)
        {
            ...
            //if (allocatedGO.GetComponent<Rigidbody>() != null)
            //    Destroy(allocatedGO.GetComponent<Rigidbody>());
